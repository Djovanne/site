...
@app.route('/dadosColetados', methods=['GET'])
def dadosColetados():
    ...
    if (0 <= ultima_qtd_passageiros) and (ultima_qtd_passageiros <= 15):
        densidade = 1

    elif (16 <= ultima_qtd_passageiros) and (ultima_qtd_passageiros <= 31):
        densidade = 2

    elif (32 <= ultima_qtd_passageiros) and (ultima_qtd_passageiros <= 47):
        densidade = 3

    elif (48 <= ultima_qtd_passageiros) and (ultima_qtd_passageiros <= 63):
        densidade = 4

    else:
        densidade = 5

    return render_template('dadosColetados.html',ultima_qtd_passageiros=ultima_qtd_passageiros,
                                                 densidade=densidade)
